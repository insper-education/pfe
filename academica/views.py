...
def dinamicas_grupos(request):
    ...
    if request.method == "POST":
        ...
        cabecalhos = [{"pt": "Nome", "en": "Name"},
                        ...
                        {"pt": "Curso", "en": "Program"},
                        {"pt": "Projeto", "en": "Project", "tipo": "numeral"},
                        {"pt": "Quinzenal Realizado", "en": "Biweekly Completed", "tipo": "numeral"},
                        {"pt": "Quinzenal Adequado", "en": "Biweekly Adequate", "tipo": "numeral"},
                        {"pt": "Pares Int. Entrega", "en": "Int. Pairs Delivery", "tipo": "numeral"},
                        {"pt": "Pares Int. Iniciativa", "en": "Int. Pairs Initiative", "tipo": "numeral"},
                        {"pt": "Pares Int. Comunicação", "en": "Int. Pairs Communication", "tipo": "numeral"},
                        {"pt": "Pares Fin. Entrega", "en": "Fin. Pairs Delivery", "tipo": "numeral"},
                        {"pt": "Pares Fin. Iniciativa", "en": "Fin. Pairs Initiative", "tipo": "numeral"},
                        {"pt": "Pares Fin. Comunicação", "en": "Fin. Pairs Communication", "tipo": "numeral"},
                        ]
