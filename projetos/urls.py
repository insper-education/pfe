...
urlpatterns = [
    ...
    path("cria_reuniao/<str:reuniao_id_g>", views.reuniao, name="cria_reuniao"),
    path("edita_reuniao/<str:reuniao_id_g>", views.reuniao, name="edita_reuniao"),
    ...
    path("projeto_infos/", views.projeto_infos, name="projeto_infos"),
    ...
    path("funcionalidades_grupos/", views.funcionalidades_grupos, name="funcionalidades_grupos"),
    ...
    path("upload_horarios_aulas/<int:projeto_id>", views.upload_horarios_aulas, name="upload_horarios_aulas"),
