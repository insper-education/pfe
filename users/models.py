...
class Professor(models.Model):
    ...
    #   REMOVER POIS NÃO MAIS USADO, AGORA EM AreaDeInteresse
    areas = models.TextField(max_length=500, null=True, blank=True, help_text="Áreas de Interesse do Professor")
    ##########################################################
