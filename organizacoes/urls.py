...
urlpatterns = [
    ...
    path("anotacao/<int:organizacao_id>",
        views.anotacao,
        name="anotacao"),

    path("anotacao/<int:organizacao_id>/<int:anotacao_id>/",
        views.anotacao,
        name="anotacao"),
    ...
    path("adiciona_documento/<int:organizacao_id>/<int:projeto_id>",
        views.adiciona_documento,
        name="adiciona_documento"),

    path("adiciona_documento/<int:organizacao_id>/<int:projeto_id>/<str:tipo_nome>",
        views.adiciona_documento,
        name="adiciona_documento"),

    path("adiciona_documento/<int:organizacao_id>/<int:projeto_id>/<str:tipo_nome>/<int:documento_id>",
        views.adiciona_documento,
        name="adiciona_documento"),
    ...
    path("adiciona_documento_estudante/<str:tipo_nome>/<int:documento_id>",
        views.adiciona_documento_estudante,
        name="adiciona_documento_estudante"),
